<!--
	...
	Purpose: A simple navagation bar for other screens and a picture of a night sky
-->
<!DOCTYPE html>
<html>
	<head>
	...
	<div>
		<ul>
			...
			<li>
				<a href="#" class="dropbtn">Main Menu</a>
			</li>
			<li class="dropdown">
		...
		<img src="sky.jpg" alt="Image Of Night sky" width="1040" height="590"><!--https://blog.hootsuite.com/20-free-stock-photo-sites-social-media-images/-->
	</body>
</html>	